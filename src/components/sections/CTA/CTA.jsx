...
function CTA() {
  return (
    <motion.section id="cta" className="cta-section">
      ...
      <div class="cta-body">
        <p>
          Good collaboration is not just about delivering results. It is about
          working with someone who is invested in what you are building, not
          just assigned to it.
        </p>
        <p>If that is the standard you expect, you are in the right place.</p>
      </div>
        ...
        <div className="about-stats">
          ...
          >
            {leftStats.map((statData, i) => (
              <motion.div key={i} variants={leftVariants} className="stat-card">
